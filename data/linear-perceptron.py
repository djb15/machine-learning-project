# File name: linear-perceptron.py
# Author: Dirk Brink
...
classifier = Perceptron(max_iter=10000) #Anything greater than 10,000 made no difference
...
train_scores, test_scores = validation_curve(Perceptron(max_iter=10000, penalty='l2'), X_train, y_train, "alpha", param_range)
